...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = """
🎮 <b>TRIBES: LAST STANDING — COMPLETE GAMEPLAY GUIDE</b>
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<b>🎲 RANDOM EVENTS (75% chance per player per round):</b>
...
<b>📊 РЕСУРСЫ:</b>
• 🍞 Еда — расходуется юнитами каждый раунд. Если еда ушла в минус — население ГОЛОДАЕТ!
• 🙏 Вера — предотвращает бунты. Если Вера < 200, есть 10% шанс БУНТА каждый раунд
...
• Если Вера < 200: 10% шанс БУНТА каждый раунд
• Бунт = -30% населения +5 депрессии

<b>🎲 СЛУЧАЙНЫЕ СОБЫТИЯ (75% шанс на игрока в раунд):</b>
